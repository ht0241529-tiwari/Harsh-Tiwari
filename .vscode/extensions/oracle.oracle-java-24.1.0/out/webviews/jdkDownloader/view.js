            ...
            try {
                ...
                if ((0, utils_1.isString)(availableVersions)) {
                    ...
                    if (availableVersionsObj === null || availableVersionsObj === void 0 ? void 0 : availableVersionsObj.items) {
                        const jdkVersions = (_a = availableVersionsObj === null || availableVersionsObj === void 0 ? void 0 : availableVersionsObj.items) === null || _a === void 0 ? void 0 : _a.map((version) => String(version.jdkDetails.jdkVersion).replace(/[^a-zA-Z0-9_.+-]/g, ""));
